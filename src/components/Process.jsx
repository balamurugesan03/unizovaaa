...
export default function Process() {
  ...
  useScrollReveal(sectionRef, '.process-step', { y: 30, stagger: 0.1 })
  ...
  return (
    <section id="process" ref={sectionRef} className="relative bg-[var(--color-bg)] py-28 md:py-36">
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-5 md:gap-6">
            {processSteps.map((s) => (
              <div key={s.step} className="process-step relative">
                <div className="mb-6 h-2.5 w-2.5 rounded-full bg-[var(--color-accent-2)] md:mb-8" />
